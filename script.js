    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "עוזי כרמי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
window.onload = function() {
    ...
    // API URL: https://qaapi.zappy5.com
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const apiUrl = 'https://qaapi.zappy5.com';
                ...
                const response = await fetch(endpoint, {
                    ...
                    body: JSON.stringify({
                        websiteId: 'd84459d1-13a6-4942-9a75-c9daf4fd4691',
                        name: data.name,
                        email: data.email,
                ...
                console.error('Failed to connect to:', 'https://qaapi.zappy5.com/api/email/contact-form');
